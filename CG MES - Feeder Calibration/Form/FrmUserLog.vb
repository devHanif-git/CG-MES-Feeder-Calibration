Public Class FrmUserLog
    ...
    Public Sub New()
        InitializeComponent()
    End Sub
    Private Sub FrmUserLog_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        FrmMain.Show()
    End Sub
    ...
    Private Sub SetupDGV()
        With dgvUserLogs
            ...
            Dim columns As String() = {"No.", "Record Time", "Name", "Employee ID", "Feeder ID", "Description"}
            Dim widths As Integer() = {40, 140, 180, 80, 65, 350}
    ...
    Private Sub LoadDatatoDGV()
        ...
        If SQL.RecordCount > 0 Then
            For i As Integer = 1 To SQL.DBDT.Rows.Count
                ...
                dgvUserLogs.Rows.Add(New Object() {i.ToString + ".", recordTime, userName, userID, textFeederID,
                               desc})
            Next
        End If
    End Sub
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            Try
                ...
                Else
                    ...
                    Dim dataTypes As String() = {"RecordTime", "UserName", "UserID", "FeederNumber"}
