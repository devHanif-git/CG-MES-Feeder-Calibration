...
Public Class SQLControl
    'DUMMY DB
    Private DBCon As New SqlConnection("Data Source=192.168.1.44\CG_MESDUMMY,1434;Initial Catalog=CGMES;User ID=admin;password=eLuQr3GghsMgqGj;Connection Timeout=30;")
    'REAL DB
